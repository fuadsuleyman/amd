# Generated by Django 3.1.4 on 2021-03-05 19:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color_code', colorfield.fields.ColorField(blank=True, default='', max_length=18, null=True, verbose_name='Color code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_details_propert_value', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_details_property_value', to='product.product_details_property_value')),
